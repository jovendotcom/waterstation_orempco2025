        ...
        <div class="d-flex gap-2">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href=" {{ route('stocks.exportAdmin', ['format' => 'excel']) }} "><i class="fas fa-file-excel me-1"></i> Export as Excel</a></li>
                    <li><a class="dropdown-item" href=" {{ route('stocks.exportAdmin', ['format' => 'pdf']) }} "><i class="fas fa-file-pdf me-1"></i> Export as PDF</a></li>
                </ul>
            </div>
...
<div class="modal fade" id="addStockModal" tabindex="-1" aria-labelledby="addStockModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-lg"> <!-- WIDER MODAL -->
        <div class="modal-content">
            ...
            <form action="{{ route('stocks.storeAdmin') }}" method="POST">
                @csrf
...
<div class="modal fade" id="updateStockModal" tabindex="-1" aria-labelledby="updateStockModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('stocks.updateAdmin') }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="modal-body">
                    <div class="mb-3">
