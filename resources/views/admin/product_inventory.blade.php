                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <!-- Size Options Dropdown -->
                            <div class="mb-3">
                                <label for="edit_size_options" class="form-label">Size Options</label>
                                <select class="form-select @error('size_options') is-invalid @enderror" id="edit_size_options" name="size_options">
                                    <option value="">Select Size</option>
                                    @foreach($sizeOptions as $size)
                                        <option value="{{ $size }}">{{ $size }}</option>
                                    @endforeach
