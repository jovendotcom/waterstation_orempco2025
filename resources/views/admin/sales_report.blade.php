...
<script>
    document.getElementById('exportExcelBtn').addEventListener('click', function () {
        ...
        window.location.href = `{{ route('admin.export.excel') }}?from_date=${fromDate}&to_date=${toDate}`;
    });
    ...
    document.getElementById('exportPdfBtn').addEventListener('click', function () {
        ...
        window.location.href = `{{ route('admin.export.pdf') }}?from_date=${fromDate}&to_date=${toDate}`;
    });
</script>
@endsection